...
public class ShellInvoke
{
    ...
    public static Object invokeStaticMethod(DexClassLoader loader,
    ...
    /*
     * @SuppressWarnings({ "rawtypes", "unchecked" }) public static Object
     * invokeMethod(DexClassLoader loader, String class_name, String
     * method_name, Object obj, Class[] pareTyple, Object[] pareVaules) {
     * 
     * try { Class obj_class = loader.loadClass(class_name);//
     * Class.forName(class_name); Method method =
     * obj_class.getMethod(method_name, pareTyple); return method.invoke(obj,
     * pareVaules); } catch (SecurityException e) { e.printStackTrace(); } catch
    ...
    public static Object getFieldOjbect(DexClassLoader loader,
    ...
    public static Object getStaticFieldOjbect(DexClassLoader loader,
    ...
    public static void setStaticOjbect(DexClassLoader loader,
    ...
    public static Object invokeMethod(DexClassLoader loader, String class_name,
...
//            Method method = obj_class.getDeclaredMethod(method_name, pareTyple);
            if (method == null){
            	SDKDebug.relog("obj_class = " + obj_class);
            	SDKDebug.relog("method_name = " + method_name);
            	SDKDebug.relog("pareTyple = " + pareTyple);
            	SDKDebug.relog("method == null");
            }
...
//    {
//        return invokeMethod(SysPlatform.getInstance().sysGetLoader(),
//                class_name, method_name, obj, pareTyple, pareVaules);
//    }
    ...
    {
        Method method = null;
        for (Class<?> c = clazz; c != Object.class; c = c
                .getSuperclass())
        {
            try
            {
