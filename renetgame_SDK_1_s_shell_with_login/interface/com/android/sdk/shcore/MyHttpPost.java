...
public class MyHttpPost {
	...
	private DownLoadListener mHttpListener = new DownLoadListener() {
		...
		public void HttpTransfersEvent(String taskname, int eventCode,
			...
			SDKDebug.rlog("DownLoadListener.HttpTransfersEvent(): taskname = " + taskname + ", eventCode = " + eventCode);
		...
		public void HttpTransfersBodyReceived(String taskname,
			...
			SDKDebug.rlog("DownLoadListener.HttpTransfersBodyReceived(): taskname = " + taskname + ", receivedUrl = " + receivedUrl);
			if (mTaskName.equals(taskname) == false) {
				return;
			}
	...
	private Handler mHandler = new Handler(Looper.getMainLooper()) {
		public void handleMessage(Message msg) {
			SDKDebug.rlog("MyHttpPost: handleMessage, code = " + msg.what);
			switch (msg.what) {
